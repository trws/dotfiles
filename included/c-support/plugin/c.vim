...
"
let s:C_GlobalTemplateFile    = s:plugin_dir.'included/c-support/c-support/templates/Templates'
let s:C_GlobalTemplateDir     = fnamemodify( s:C_GlobalTemplateFile, ":p:h" ).'/'
let s:C_LocalTemplateFile     = $HOME.'/.vim/included/c-support/c-support/templates/Templates'
